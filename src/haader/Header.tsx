...
type PropsType = {
    ...
    setPrevUrlSupportPage: (url: string) => void
}
    ...
    return (
        <>
            <div className="header">
                <Link
                    onClick={() => {
                        props.setPrevUrlSupportPage(location.pathname)
                    }}
                    to="informationPage">
...
export default connect(mapStateToProps, { setSelectedLanguage: actions.setSelectedLanguage, setPrevUrlSupportPage: actions.setPrevUrlSupportPage })(Header)
